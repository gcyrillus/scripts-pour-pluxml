...
<ul class="cat-list unstyled-list">
	<?php 
		...
		$length ='20';				// indiquez ici le nombre de lettre à afficher
		...
		foreach($menu as $id_cat => $ar) {
			...
			$plxShow->catList('','<li id="menu_#cat_id" class="#cat_status"><a href="#cat_url">#cat_name</a><ul>'. $listArts.'</ul><p><a href="#cat_url" title="Voir tous les articles de la catégorie #cat_name">Voir tous les articles</a></p></li>',
			$id_cat);
		} ?>            
</ul>
