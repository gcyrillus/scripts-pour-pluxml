<?php 
	...
	if(($plxShow->staticId()) && $plxShow->plxMotor->aConf['homestatic'] == str_pad($plxShow->staticId(),3,'0',STR_PAD_LEFT) && !isset($_SESSION['profil']))
			...
			<div class="grid">				
				<div class="content col sml-12">
					<article class="article" >
						...
						<form method="post" action="<?= $_SERVER['REQUEST_URI'] ?>" id="form_auth">
							<fieldset>
	...
	<style>li#static-blog,li#static-<?= ltrim($plxShow->plxMotor->aConf['homestatic'],'0') ?>{display:none;}</style>
	<?php 
